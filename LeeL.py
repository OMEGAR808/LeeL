...
def rndmx():
    ...
    with tred(max_workers=30) as tanox:
            ...
            for psx in jan:
                ids = dog+psx
                passlist = [psx,ids,ids[:8],ids[:7],ids[:6]]
